...
- (void)setBorderThickness:(CGFloat)borderThickness{
    ...
    //left
    if (self.borderType & KKBorderTypeLeft) {
        self.leftBorder.frame = CGRectMake(0, 0, borderThickness, self.frame.size.height);
    }
    //right
    if (self.borderType & KKBorderTypeRight) {
        self.rightBorder.frame = CGRectMake(self.frame.size.width - borderThickness, 0, borderThickness, self.frame.size.height);
    }
    //top
    if (self.borderType & KKBorderTypeTop) {
        self.topBorder.frame = CGRectMake(0, 0, self.frame.size.width, borderThickness);
    }
    //bottom
    if (self.borderType & KKBorderTypeBottom) {
        self.bottomBorder.frame = CGRectMake(0, self.frame.size.height - borderThickness, self.frame.size.width, borderThickness);
    }
}
